        ...
        for (let l = 0; l < this.lights.length; l++) {
            ...
            for (let i = 0; i < this.meshes.length; i++) {
                ...
                for (let k in this.meshes[i].material.uniforms) {
                    ...
                    mat4.fromRotation(cameraModelMatrix, timer*5, [0, 1, 0]);//edit line
                    ...
                    //let array = [[0, 1, 0]]
                    //let A = SHEval(array[0], array[1], array[2], 2);
                    //let array_R = math.multiply(array, cameraModelMatrix)
                    //let S = SHEval(array_R[0], array_R[1], array_R[2], 2);
                    //let M = math.multiply(S,A)


                    // Bonus - Fast Spherical Harmonic Rotation
                    let precomputeL_RGBMat3 = getRotationPrecomputeL(precomputeL[guiParams.envmapId], cameraModelMatrix);
                    let Mat3Value = getMat3ValueFromRGB(precomputeL_RGBMat3);
                    //Mat3Value = getRotationPrecomputeL(precomputeL_RGBMat3, cameraModelMatrix);
